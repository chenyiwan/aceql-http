...
public class WebServer {
     ...
     * @throws ConnectException               if server is unable to connect to specified or default 9090
     *                                        port
     * @throws DatabaseConfigurationException if any error in configuration properties file
     */
